...
// (2) JSX를 사용하지 않는 방법 -> 넣을 요소를 createElement() 메서드로 생성해야함
...
/***************************************************** 
    ...
    -> 1),2)번을 사용하는 이유는 쓸때 없는 태그삽입을 막는데 있다!
...
const myEle5 = (
  <React.Fragment>
    ...
    <ul>
      {
        mydata.map(v=>
          <li>{v.name} : {v.movie} : {v.idx == 3? "예뻐❤": "멋져🍕"}</li>
        )
      }
    </ul>
  </React.Fragment>
...
/***************************************************** 
    ...
    <태그 className="클래스명">
    -> 리액트 버전 16부터 class라고 써도 자동변환하여 
    클래스를 표시해주지만 경고메시지가 뜬다
*****************************************************/

// 7. 속성으로 클래스 셋팅하여 사용하기 /////////
const myEle7 = (
  <h1 class="myclass">
    className 속성으로 클래스를 셋팅한다!</h1>
);
