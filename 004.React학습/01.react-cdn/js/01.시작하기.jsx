...
하나로 묶는 역할만하고 실제로 태그는 출력안됨
(#참고 : CLI환경(개발환경)에서는 빈태그를 대신 사용가능함 <></> )

*/

// 이곳에서 만든 함수를 생성자함수라고 함
// 생성자 함수를 만들어서 사용
// 대문자로 시작하는 이름을 사용한다
function MyFirstReact() {
  ...
  return (
    <React.Fragment>
      <h1>나는 리액트가 좋아질 것 같다ㅎㅎ</h1>
      <h2>
        [리액트란 무엇인가?]
      <img src="https://cdn.icon-icons.com/icons2/2415/PNG/512/react_original_wordmark_logo_icon_146375.png" alt="리액트 로고"></img>
        <br />
