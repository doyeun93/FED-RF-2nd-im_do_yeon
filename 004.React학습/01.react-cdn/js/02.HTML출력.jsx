...
// JSX 태그 중간에 변수나 수식을 출력할때는 중괄호맍 사용함
// <dic>{변수/표현식}</div>
...
// 위의 데이터를 사용하여 table>tr>td 태그 구성하여 코드를 작성한다
// -> map()메서드를 사용한다. 
// 과연 이 함수는 JS 순수 함수인가? : NO / 리액트의 map()메서드는 리액트전용임
// 그래서 html태그를 화면에 출력할때 JS에서 했던 join('')메서드를 
// 사용하지 않아도 태그가 그대로 클린하게 출력된다
